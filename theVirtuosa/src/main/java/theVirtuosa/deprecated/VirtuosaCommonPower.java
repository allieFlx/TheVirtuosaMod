...
import theVirtuosa.powers.CommonPower;

import static theVirtuosa.TheVirtuosa.makeCardPath;
@AutoAdd.Ignore
public class VirtuosaCommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = TheVirtuosa.makeID(VirtuosaCommonPower.class.getSimpleName());
