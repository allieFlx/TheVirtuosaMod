...
@AutoAdd.Ignore
public class VirtuosaSecondMagicNumberSkill extends AbstractDynamicCard {
    ...
    public static final String ID = TheVirtuosa.makeID(VirtuosaSecondMagicNumberSkill.class.getSimpleName());
    ...
    public VirtuosaSecondMagicNumberSkill() {
        super(ID, IMG, COST, TYPE, COLOR, RARITY, TARGET);

        magicNumber = baseMagicNumber = VULNERABLE;
        virtuosaSecondMagicNumber = virtuosaBaseSecondMagicNumber = POISON;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(m, p, new PoisonPower(m, p, this.virtuosaSecondMagicNumber), this.virtuosaSecondMagicNumber));
    ...
    public void upgrade() {
        if (!this.upgraded) {
            ...
            this.upgradeVirtuosaSecondMagicNumber(UPGRADE_PLUS_POISON);
