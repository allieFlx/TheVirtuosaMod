...
public class VirtuosaHelplessPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = TheVirtuosa.makeID("VirtuosaHelplessPower");
    ...
    public AbstractPower makeCopy() {
        return new VirtuosaHelplessPower(owner, amount);
    }
}
