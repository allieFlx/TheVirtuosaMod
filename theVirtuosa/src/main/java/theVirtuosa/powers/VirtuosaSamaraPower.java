...
public class VirtuosaSamaraPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = TheVirtuosa.makeID("VirtuosaSamaraPower");
    ...
    public VirtuosaSamaraPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new VirtuosaSamaraPower(owner, amount);
    }
}
