...
import theVirtuosa.deprecated.VirtuosaRareAttack;
...
public class RarePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = TheVirtuosa.makeID("RarePower");
    ...
    public void atStartOfTurn() { // At the start of your turn
        AbstractCard playCard = new VirtuosaRareAttack(); // Declare Card - the DefaultRareAttack card. We will name it 'playCard'.
