...
public class VirtuosaMossShieldPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = TheVirtuosa.makeID("VirtuosaMossShieldPower");
    ...
    public VirtuosaMossShieldPower(final AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new VirtuosaMossShieldPower(owner, amount);
    }
}
