...
import theVirtuosa.variables.DefaultCustomVariable;
import theVirtuosa.variables.VirtuosaSecondMagicNumber;
...
public class TheVirtuosa implements
    ...
    public static Properties theVirtuosaDefaultSettings = new Properties();
    public static final String ENABLE_PLACEHOLDER_SETTINGS = "enablePlaceholder";
    public static boolean enablePlaceholder = true; // The boolean we'll be setting on/off (true/false)

    //This is for the in-game mod settings panel.
    private static final String MODNAME = "The Virtuosa";
    private static final String AUTHOR = "allieflx"; // And pretty soon - You!
    private static final String DESCRIPTION = "Mod that adds the character The Virtuosa.";
    ...
    private static final String POWER_VIRTUOSA_BROWN = "theVirtuosaResources/images/512/bg_power_default_chatreuse.png";
    ...
    private static final String ATTACK_VIRTUOSA_BROWN_PORTRAIT = "theVirtuosaResources/images/1024/bg_attack_default_chatreuse.png";
    ...
    private static final String THE_VIRTUOSA_PORTRAIT = "theVirtuosaResources/images/charSelect/VirtuosaCharacterPortraitBG_BETA.png";
    public static final String THE_VIRTUOSA_SHOULDER_1 = "theVirtuosaResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_VIRTUOSA_SHOULDER_2 = "theVirtuosaResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_VIRTUOSA_CORPSE = "theVirtuosaResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theVirtuosaResources/images/Badge.png";
    ...
    public TheVirtuosa() {
        ...
        setModID("theVirtuosa");

        logger.info("Done subscribing");
        
        logger.info("Creating the color " + TheVirtuosaCharacter.Enums.COLOR_BROWN.toString());
        
        BaseMod.addColor(TheVirtuosaCharacter.Enums.COLOR_BROWN, VIRTUOSA_BROWN, VIRTUOSA_BROWN, VIRTUOSA_BROWN,
                VIRTUOSA_BROWN, VIRTUOSA_BROWN, VIRTUOSA_BROWN, VIRTUOSA_BROWN,
                ATTACK_VIRTUOSA_BROWN, SKILL_VIRTUOSA_BROWN, POWER_VIRTUOSA_BROWN, ENERGY_ORB_VIRTUOSA_BROWN,
                ATTACK_VIRTUOSA_BROWN_PORTRAIT, SKILL_VIRTUOSA_BROWN_PORTRAIT, POWER_VIRTUOSA_BROWN_PORTRAIT,
                ENERGY_ORB_VIRTUOSA_BROWN_PORTRAIT, CARD_ENERGY_ORB);
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = TheVirtuosa.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = TheVirtuosa.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = TheVirtuosa.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        TheVirtuosa defaultmod = new TheVirtuosa();
    ...
    public void receiveEditCharacters() {
        ...
        receiveEditPotions();
        logger.info("Added " + TheVirtuosaCharacter.Enums.THE_VIRTUOSA.toString());
    }
    ...
    public void receivePostInitialize() {
        ...
        AddEventParams eventParams = new AddEventParams.Builder(IdentityCrisisEvent.ID, IdentityCrisisEvent.class) // for this specific event
            ...
            .playerClass(TheVirtuosaCharacter.Enums.THE_VIRTUOSA) // Character specific event
            .create();
    ...
    public void receiveEditRelics() {
        ...
        /*
        * BaseMod.addRelicToCustomPool(new PlaceholderRelic(), TheVirtuosa.Enums.COLOR_BROWN);
        * BaseMod.addRelicToCustomPool(new BottledPlaceholderRelic(), TheVirtuosa.Enums.COLOR_BROWN);
        * BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), TheVirtuosa.Enums.COLOR_BROWN);
        */
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addDynamicVariable(new VirtuosaSecondMagicNumber());
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(PowerStrings.class,
                getModID() + "Resources/localization/eng/TheVirtuosa-Power-Strings.json");
        
        // RelicStrings
        BaseMod.loadCustomStringsFile(RelicStrings.class,
                getModID() + "Resources/localization/eng/TheVirtuosa-Relic-Strings.json");
        
        // Event Strings
        BaseMod.loadCustomStringsFile(EventStrings.class,
                getModID() + "Resources/localization/eng/TheVirtuosa-Event-Strings.json");
        
        // PotionStrings
        BaseMod.loadCustomStringsFile(PotionStrings.class,
                getModID() + "Resources/localization/eng/TheVirtuosa-Potion-Strings.json");
        
        // CharacterStrings
        BaseMod.loadCustomStringsFile(CharacterStrings.class,
                getModID() + "Resources/localization/eng/TheVirtuosa-Character-Strings.json");
        
        // OrbStrings
        BaseMod.loadCustomStringsFile(OrbStrings.class,
                getModID() + "Resources/localization/eng/TheVirtuosa-Orb-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(getModID() + "Resources/localization/eng/TheVirtuosa-Keyword-Strings.json").readString(String.valueOf(StandardCharsets.UTF_8));
